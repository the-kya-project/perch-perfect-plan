      ...
      {showBasics && (
        <Section title="Basics">
          <div className="flex items-center gap-4">
            {bird.photo_url ? (
              <img src={bird.photo_url} alt={bird.name} className="block size-16 rounded-2xl object-cover ring-1 ring-[#e0d8c4]" style={{ objectPosition: bird.photo_position ?? "50% 15%" }} />
            ) : (
