...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cw4HTLqX.mjs");
...
const manifest = {
  "08b04c880185fa9688c2b98c5c9d1b8fa87038e0577bb5cc1885a88fffc153cc": {
    functionName: "deletePushSubscription_createServerFn_handler",
    importer: () => import("./push.functions-Ca-yl-qm.mjs")
  },
  "27301031363e284184ead21ac910c33ebfbe9159435c975f26319c6a65fade88": {
    functionName: "deleteMyAccount_createServerFn_handler",
    importer: () => import("./account.functions-fLM5_xyZ.mjs")
  },
  "3dd075d941fe87add5a112b1d488c70b7f22ef898e03c52b61a8df45a139ffeb": {
    functionName: "savePushSubscription_createServerFn_handler",
    importer: () => import("./push.functions-Ca-yl-qm.mjs")
  },
  "50cb8f45f66e937d950971564c827d6b93feac9abf3e61bbc9b3d96c12ce922f": {
    functionName: "getSitterContext_createServerFn_handler",
    importer: () => import("./sitter.functions-URAYfoKa.mjs")
  },
  "62e39282bef46fbf34bede070d2f06f18924ed0ea466fbc7ce31bb612a1b943a": {
    functionName: "submitHealthScan_createServerFn_handler",
    importer: () => import("./sitter.functions-URAYfoKa.mjs")
  },
  "78cc8d1f6340d6a3afbbfa56eb27d07047d617e75a30cf50925c68148d0e296a": {
    functionName: "getVapidPublicKey_createServerFn_handler",
    importer: () => import("./push.functions-Ca-yl-qm.mjs")
  },
  "8ce1c9c9a340fa1f4f599420438c639d99ad297758879e6c48d6681ae24abd15": {
    functionName: "getGuideCards_createServerFn_handler",
    importer: () => import("./sitter.functions-URAYfoKa.mjs")
  },
  "dc345fee44e99de68d1e2909355bedb00b78b877879c1ce3d16ec502e757ff98": {
    functionName: "uploadDroppingsPhoto_createServerFn_handler",
    importer: () => import("./sitter.functions-URAYfoKa.mjs")
  },
  "df233a4b290a36bb9e590e32dfac9aae25c6873908fa14f6aa9c1760b8843e1b": {
    functionName: "toggleTaskCompletion_createServerFn_handler",
    importer: () => import("./sitter.functions-URAYfoKa.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Cu2Tdjxf.mjs").then((n) => n.r),
    import("./start-CY05MJE1.mjs"),
